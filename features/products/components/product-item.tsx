...
const ProductItem = ({ data }: { data: productProps }) => {
  ...
  return (
    <TouchableOpacity
      ...
      key={data?.id}
      className="m-2 h-[260px] w-1/2 gap-2 rounded-[10px] bg-white">
      <Image
      ...
      <View className="flex-col px-2">
        ...
        <Text className="line-clamp-1 max-w-[140px] font-raleway-500 text-base font-medium tracking-normal text-black">
          {data?.title}
        </Text>
